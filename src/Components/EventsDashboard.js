...
const EventsDashboard = (props) => {
    return(
        <div id='eventsNav'>
            ...
            <StyledEventsButtons>
                <StyledP>To organize an event, click the "Create Event" button below! <br/>If you are an organizer on an existing event and would like to edit the date, location, time, item list, or guest list of your event, click on the "Edit Event" button below. <br/>To view your current event invitations, click on "Your Events."</StyledP>
